...
const WordSetForm: React.FC = () => {
    ...
    const handleAddOrUpdateWord = async (e: React.FormEvent) => {
        ...
        const word: Word = { setId: Number(setId), word: newWord, translation: newTranslation };
    ...
    return (<div className="container mx-auto p-8 bg-white shadow-lg rounded-lg">
        <h2 className="text-2xl font-extrabold mb-6 text-gray-800">Manage Words in Set</h2>
        ...
        <ul className="space-y-4">
            {words.map((word) => (
                <li key={word.id} className="flex justify-between items-center p-3 border-b border-gray-200">
